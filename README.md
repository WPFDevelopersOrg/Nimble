...
建议将 `Nimble` 灵动 安装到其他磁盘分区，比如 `D` 盘或其他可用磁盘，这样可以确保软件能够正确地记录和保存各项操作。 
...
### 新增桌面动态壁纸
<img src="https://github.com/WPFDevelopersOrg/ResourcesCache/raw/main/resources/SoftwareHelperResource/convertNimble-Close.gif"/>  
